...
The prompt that you write as part of [prompt bot creation](/docs/how-to-create-a-prompt-bot) is passed to the underlying model as a system message. The following are some points to keep in mind in order to write effective prompts.
