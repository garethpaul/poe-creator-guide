...
`garethpaul/poe-creator-guide` is a static web project. No GitHub description is currently set.
...
- Review changes touching external API calls or credential-adjacent configuration; examples from the scan include docs/accessing-other-bots-on-poe.md, docs/enabling-file-upload-for-your-bot.md, docs/examples.md, docs/fastapi_poe-python-reference.md, and 5 more.
...
- Review changes touching mobile permissions or privacy-sensitive device data; examples from the scan include docs/best-practices-for-video-generation-prompts.md, docs/canvas-limitations.md, docs/fundraising.md, docs/server-bots-functional-guides.md, and 2 more.
